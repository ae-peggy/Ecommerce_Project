...
if (!$reference) {
    ...
    header('Location: ../view/checkout.php?error=cancelled');
    exit();
}
            ...
            try {
                ...
                if (data.status === 'success' && data.verified) {
                    ...
                    setTimeout(() => {
                        ...
                        window.location.replace(`../view/payment_success.php?reference=${encodeURIComponent(reference)}&invoice=${encodeURIComponent(data.invoice_no)}`);
                    }, 500);
                    ...
                    setTimeout(() => {
                        window.location.href = '../view/checkout.php?error=verification_failed';
                    }, 5000);
                }
                ...
                // Redirect after 5 seconds
                setTimeout(() => {
                    window.location.href = '../view/checkout.php?error=connection_error';
                }, 5000);
            }
        }
