...
try {
    ...
    try {
        ...
        // Create order in database with delivery information
        $order_id = create_order_ctr($customer_id, $invoice_no, $order_date, 'Paid', $delivery_location, $recipient_name, $recipient_number, $delivery_notes);
