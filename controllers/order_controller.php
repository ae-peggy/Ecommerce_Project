 ...
 * @param string|null $delivery_location - Delivery location/address
 * @param string|null $recipient_name - Recipient name
 * @param string|null $recipient_number - Recipient phone number
 * @param string|null $delivery_notes - Additional delivery notes
 * @return int|false - Returns order_id if successful, false if failed
 */
function create_order_ctr($customer_id, $invoice_no, $order_date, $order_status, $delivery_location = null, $recipient_name = null, $recipient_number = null, $delivery_notes = null) {
    $order = new order_class();
    return $order->create_order($customer_id, $invoice_no, $order_date, $order_status, $delivery_location, $recipient_name, $recipient_number, $delivery_notes);
}
