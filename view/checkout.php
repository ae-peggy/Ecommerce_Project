...
<body>
    ...
    <div id="paymentModal" class="modal">
        <div class="modal-content">
            ...
            <h2 class="modal-title">Simulate Payment</h2>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #374151 100%); color: white; padding: 20px; border-radius: 12px; margin: 20px 0; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
                <div style="font-size: 12px; margin-bottom: 10px; opacity: 0.8;">DUMMY CARD</div>
                <div style="font-size: 18px; letter-spacing: 2px; margin-bottom: 15px;">•••• •••• •••• 4242</div>
                <div style="display: flex; justify-content: space-between;">
                    <div style="font-size: 12px; opacity: 0.8;">EXPIRES 12/25</div>
                    <div style="font-size: 12px; opacity: 0.8;">CVV 123</div>
                </div>
            </div>
            ...
            <div class="modal-buttons">
                ...
                <button onclick="processCheckout()" id="confirmPaymentBtn" class="btn btn-primary">Confirm Payment</button>
            </div>
        </div>
    </div>
